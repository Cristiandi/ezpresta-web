      ...
      <div className="cds--grid">
        <div className="cds--row">
          ...
          <div className="cds--col-lg-16 cds--col-md-8 cds--col-sm-4">
            ...
            <h4><strong>{formatCurrency(props.minimumLoanPaymentAmount)}</strong></h4>
          </div>
          <div className="cds--col-lg-8 cds--col-md-4 cds--col-sm-2">
            <p className="loan-card__label">Fecha de pago</p>
            <p className="loan-card__payment_date">{formatDate(props.loanPaymentDate)}</p>
          </div>
          <div className="cds--col-lg-8 cds--col-md-4 cds--col-sm-2" style={{ position: "relative" }}>
            <Tag
              type={props.loanPaymentStatus === "al día" ? "green" : "red"}
              size="md"
              title="Loan status tag">
              {capitalizeFirstLetter(props.loanPaymentStatus)}
            </Tag>
          </div>
        </div>
      </div>
